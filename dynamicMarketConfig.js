...
const baseMinerals = { H: {}, O: {}, X: {}, U: {}, L: {}, K: {}, Z: {}, battery: {}, power: {}, ops: {}, }
const customConfig = {
    ...
    /** Consider this a "per user amount" as it is multiplied by the number of active player terminals */
    sellAmount: 25000,
    /** Consider this a "per user amount" as it is multiplied by the number of active player terminals */
    buyAmount: 50000,
...
function setBuyPrices(basePrices) {
    ...
    for (let commodity in commodities) {
        if (buyPrices[commodity] == undefined) {
